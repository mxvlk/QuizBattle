...
import { fetchFinishedGames } from "../../util/fetchers/FinishedGames";

export function FinishedGamesList() {
    ...
    const { data, isError, isLoading } = useQuery(['finshedGames'], () => fetchFinishedGames(auth()!.username, token), {
